...
WALLY_CORE_API int wally_tx_set_input_script(const struct wally_tx *tx_in, size_t index, const unsigned char *script_in, size_t script_len_in);
WALLY_CORE_API int wally_tx_set_input_witness(const struct wally_tx *tx_in, size_t index, const struct wally_tx_witness_stack *tx_witness_stack_in);
